  ...
  const ListHeader = () => (
    <View>
      ...
      <View style={styles.albumInfoCard}>
        ...
        >
          <Text style={styles.albumLabel} className='font-bold'>Radio</Text>
    ...
    return (
      <View style={styles.songCard}>
        ...
        >
          ...
          {/* IMPORTANT: minWidth: 0 allows text to shrink */}
          <View style={styles.songText}>
            ...
            <Text
              ...
              ellipsizeMode="tail"
            >
              {song?.song?.more_info?.music?.replace(
                /\s*\(.*?\)\s*/g,
                ""
              )}
            </Text>

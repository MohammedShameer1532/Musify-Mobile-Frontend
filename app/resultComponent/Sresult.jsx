...
import { View, FlatList, StyleSheet, Image, ActivityIndicator, TouchableOpacity, Text, Button, ScrollView, Dimensions } from 'react-native';
...
const Sresult = () => {
  ...
  const handleCopy = () => {
    Clipboard.setString(translatedLyrics ?? lyrics ?? "");
    setCopied(true);

import { ActivityIndicator, Alert, Dimensions, FlatList, Image, PermissionsAndroid, Platform, Pressable, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
  ...
  return (
    <View className='flex mt-5'>
      <View style={styles.topSongsHeader}>
        ...
        <View style={styles.topSongsTitleContainer}>
          <View style={styles.topSongsAccent} />

          <View>
            <Text style={styles.topSongsTitle} className='font-extrabold'>
              Top Songs
            </Text>

            <Text style={styles.topSongsSubtitle}>
              Popular songs by this artist
            </Text>
          </View>
        </View>
